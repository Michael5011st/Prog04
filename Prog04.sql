...
Create table Reservations(seq int AUTO_Increment unique, date date, beginTime time, endTime time, Users int references Users(id),
...
Create View ReservationsView
	...
	date, concat(beginTime, '-', endTime) as time,
